...
assert.match(homePage, /data-topogram-region="hero"/);
assert.match(homePage, /data-topogram-screen="hello_home"/);
assert.match(homePage, /data-topogram-display-field/);
assert.match(homePage, /class="widget-card widget-summary"/);
